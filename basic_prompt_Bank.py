...
_clarification = """## CLARIFICATION OF TELEMETRY DATA:
...
schema = (
    "You will be provided with context (retrieved telemetry, logs, traces, etc.) relevant to the question. "
    "Use ONLY this context to answer. Do not make up information. If the context is insufficient, state so or ask for more information.\n\n"
    + cand + "\n\n"
    + _clarification
)
